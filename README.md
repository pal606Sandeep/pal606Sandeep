...
Currently, I’m working with **Next.js, React.js, Node.js, AWS, Docker, CI/CD, Redis, and REST APIs**.
...
- ☁️ Experienced with **AWS, Docker & CI/CD**
- 🔴 Working with **Redis & REST APIs**
- 🏗️ Experienced in building applications **from scratch to production**
- 📱 Built **Progressive Web Applications (PWA)**
- 🔧 Comfortable working across Frontend, Backend & Deployment
...
**Tech:** Next.js, React.js, Node.js, REST APIs, Redis, AWS
